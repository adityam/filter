...
%D internal names keep on changing which is a  maintenance nightmare and some
%D catcode tables are defined differently in MkII and MkIV.
...
%D In MkII, \type{\unprotect} does not change the meaning of \type{_}.
%D So, I explicitly set the catcode table to be the same as the
%D \type{\prtcatcodes} in MkIV.
...
\starttexdefinition externalfilter@process_filter
     ...
     %
     %      \doifmode\s!mkiv{\savebuffer[\externalfilter@buffer_name][\externalfilter@input_file]}
     %
