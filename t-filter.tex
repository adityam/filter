...
\def\externalfilter::preamble_name  {\externalfilter::name-preamble}
\def\externalfilter::postamble_name {\externalfilter::name-postamble}

\def\externalfilter::preamble  {filterpreamble}
\def\externalfilter::postamble {filterpostamble}
...
\setvalue{\e!start\externalfilter::preamble}%
    {\bgroup\obeylines\dosingleargument\externalfilter::start_preamble}
    
\starttexdefinition externalfilter::start_preamble [#1]
    % #1 = filter
    \egroup
    \edef\externalfilter::name{#1}

    \dostartbuffer[\externalfilter::preamble_name]
                  [\e!start\externalfilter::preamble]
                  [\e!stop\externalfilter::preamble]
\stoptexdefinition

\setvalue{\e!stop\externalfilter::preamble}{}

\setvalue{\e!start\externalfilter::postamble}%
    {\bgroup\obeylines\dosingleargument\externalfilter::start_postamble}
    
\starttexdefinition externalfilter::start_postamble [#1]
    % #1 = filter
    \egroup
    \edef\externalfilter::name{#1}

    \dostartbuffer[\externalfilter::postamble_name]
                  [\e!start\externalfilter::postamble]
                  [\e!stop\externalfilter::postamble]
\stoptexdefinition

\setvalue{\e!stop\externalfilter::postamble}{}
...
\starttexdefinition externalfilter::process_filter
     ...
     \doifmode\s!mkiv
         {\savebuffer[\externalfilter::preamble_name,\externalfilter::temp_file,\externalfilter::postamble_name]
