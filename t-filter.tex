...
\chardef\externalfilter!!method\zerocount    %0 = os, 1 = httpget, 2 = httppost
...
\def\dostartexternalfilter[#1][#2]% filter options
  {% Initializations
   ...
   \processaction[\externalfilterparameter\c!method]
                 [\v!httpget  => \chardef\externalfilter!!method\plusone ,
                  \v!httppost => \chardef\externalfilter!!method\plustwp ,
                  \v!default  => \chardef\externalfilter!!method\zerocount ,
                  \v!unknown  => \chardef\externalfilter!!method\zerocount ]%
...
\def\doprocessexternalfilter%
  {\ifcase\externalfilter!!method % os 
   ...
   \endgroup 
   % Finalization
   \ifnum\externalfilter!!method=\zerocount
     \doif{\externalfilterparameter\c!continue}\v!yes
