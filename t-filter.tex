...
\def\externalfilterparameter          #1{\csname\doexternalfilterparameter{\??externalfilter??\currentexternalfilter}#1\endcsname}
\def\doexternalfilterparameter      #1#2{\ifcsname#1#2\endcsname#1#2\else\expandafter\doexternalfilterparentparameter\csname#1\s!parent\endcsname#2\fi}
\def\doexternalfilterparentparameter#1#2{\ifx#1\relax\s!empty\else\doexternalfilterparameter#1#2\fi}
