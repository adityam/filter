...
\starttexdefinition externalfilter::define [#1][#2]
    ...
    \doifmode\s!mkiv
        {
         \setvalue{\e!start#1preamble}%
                  {\dostartbuffer[\externalfilter::preamble_name][\e!start#1preamble][\e!stop#1preamble]}
         \letvalue{\e!stop#1preamble}\donothing
         \setvalue{\e!start#1postamble}%
                  {\dostartbuffer[\externalfilter::postamble_name][\e!start#1postamble][\e!stop#1postamble]}
         \letvalue{\e!stop#1postamble}\donothing
        }
\stoptexdefinition
