...
\def\dodefineexternalfilter[#1][#2]%
  {\setupexternalfilters[#1][#2]%
   ...
   \setvalue{\e!start#1}{\dodoubleargument\dostartexternalfilter[#1]}%
...
\def\doreadprocessedfile%
  {\bgroup
   ...
   \processcommacommand[\namedexternalfilterparameter\currentexternalfilter\c!setups]\directsetup%
   \namedexternalfilterparameter\currentexternalfilter\c!readcommand\externalfilteroutputfile\relax
