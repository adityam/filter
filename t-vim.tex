...
\startvimalternative[pscolor]
  ...
  \setvimsyntax [Special]   [h=907000]      [\v!mono]
  \setvimsyntax [Comment]   [h=606000]      [\v!mono]
  \setvimsyntax [Number]    [h=907000]      [\v!mono]
  \setvimsyntax [Constant]  [h=007068]      [\v!mono]
  \setvimsyntax [PreProc]   [h=009030]      [\v!mono]
  \setvimsyntax [Statement] [h=2060a8]      [\v!mono]
  \setvimsyntax [Type]      [h=0850a0]      [\v!mono]
  \setvimsyntax [Todo]      [h=e0e090]      [\v!mono]
  \setvimsyntax [Error]     [h=c03000]      [\v!mono]
  \setvimsyntax [Identifier][h=a030a0]      [\v!mono]
  \setvimsyntax [SpecialKey][h=1050a0]      [\v!mono]
  \setvimsyntax [Underline] [h=6a5acd]      [\v!mono]
\stopvimalternative
