...
\startinterface all
  \setinterfaceconstant {trimspaces}          {trimspaces} 
\stopinterface
...
\def\vimtyping::filter_command
  {vim -u NONE % don't read global config file
       ...
       -c "let trimspaces=\getvalue{\vimtyping::id-\c!trimspaces-\externalfilterparameter\c!trimspaces}" %
       -c "source \vimtyping::script_name" %
       -c "qa" %
       \externalfilterinputfile\space
       \externalfilteroutputfile}

\setvalue{\vimtyping::id-\c!trimspaces-\v!off}{0}
\setvalue{\vimtyping::id-\c!trimspaces-\v!off}{1}

% Undocumented ... but useful if the user makes a mistake
\setvalue{\vimtyping::id-\c!trimspaces-\v!no}{0}
\setvalue{\vimtyping::id-\c!trimspaces-\v!yes}{1}
